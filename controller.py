...
#
#                 all_data.append(new_contact)
#                 record.write_formated_data()
#                 view.show_all_contact(new_contact)
#
#             case 3:
#                 view.show_all_contact (find_by(view.search_contact()))
#             case 4:
#                 search_by_val = view.search_contact()
#                 res = find_by(search_by_val)
#                 if len(res) == 0 :
...
#
#             case 5:
#                 search_by_val = view.get_text_field("Введите ключ для поиска : ")
#                 res = find_by(search_by_val)
#
#                 if len(res) == 0 :
#                     view.message("Такой контакт отсутствует в справочнике.")
